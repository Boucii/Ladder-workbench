...
when(pt3==="b011".U && pt5==="b01000".U && pt6==="b11".U){    // sd     
  ...
  src1:=regs.io.rdata1
  src2:=regs.io.rdata2
  regs.io.wdata:=Mux(src1.asSInt<src2.asSInt,0.U,1.U)
  regs.io.waddr:=dest
  regs.io.wen:=1.U
  ...
  src1:=regs.io.rdata1
  src2:=regs.io.rdata2
  intermediate:=src1.asSInt>>src2(4,0)
  ...
  src1:=regs.io.rdata1
  src2:=regs.io.rdata2
  regs.io.wdata:=src1.asSInt%src2.asSInt
  regs.io.waddr:=dest
  regs.io.wen:=1.U
  ...
  src1:=regs.io.rdata1
  src2:=immI
  regs.io.wdata:=src1.asSInt>>src2
  regs.io.waddr:=dest
  regs.io.wen:=1.U
  ...
  src1:=regs.io.rdata1
  src2:=regs.io.rdata2
  dpc:=Mux((src1.asSInt===src2.asSInt),pc,pc+dest)
  ...
  src1:=regs.io.rdata1
  src2:=regs.io.rdata2
  pc:=Mux((src1.asSInt>=src2.asSInt),pc,pc+dest)
